...
*/
createMenuItem('Corn Dogs', 3.25, 'lunch');
createMenuItem('Ham & Egg Sandwich', 6.99, 'breakfast');
createMenuItem('Steak', 14.50, 'dinner');
...
const burger = {
  ...
  price: 18, 
  category: "Lunch",
  discount: function menuDiscount(string) {
    string.toLowerCase();
...
*/
console.log(reviews[1].feedback)
